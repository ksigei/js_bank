...
//new
// const e = document.getElementById("ddlBalance");
...
function update() {
  const select = document.getElementById("ddlBalance");
  ...
  console.log("Line 28", customers[0].balance);
}
